...
function Featured() {
  return (
    <section className='pt-12 max-[507px]:pt-[38px] max-[507]:pb-[25px]  pb-8'>
        ...
        >
            <Slider.Slide>
                <img className='h-8  max-sm:h-6 brightness-0 opacity-50' src={tech} alt="" />
               </Slider.Slide>
               <Slider.Slide>
                <img className='h-8   max-sm:h-6 brightness-0 opacity-50' src={business} alt="error" />
                </Slider.Slide>
                <Slider.Slide>
                <img className='h-8  max-sm:h-6 brightness-0 opacity-50' src={neww} alt="" />
                </Slider.Slide>
                <Slider.Slide>
                <img className='h-8  max-sm:h-6 brightness-0 opacity-50' src={forbes} alt="" />
                </Slider.Slide>
                <Slider.Slide>
                <img className='h-8  max-sm:h-6 brightness-0 opacity-50' src={usa} alt="" />
            </Slider.Slide>
        </Slider>
