...
function MealSection() {
  return (
    <div className='py-24'>
       ...
       <span className='uppercase font-medium text-base block text-[#cf711f] mb-4 tracking-[0.75px] text-center'>Meals</span>
        ...
        <div className='mb-12 grid grid-cols-3 gap-x-16 px-8 mx-auto max-w-[1200px]'>
          ...
          />
        <div className='dites'>
          <h1 className='text-3xl mb-8 text-[#333] font-bold'>Works with any diet:</h1>
          <ul className='list'>
        ...
        <div className='text-center '>
          <h1 className='inline-block h-[27px] font-normal cursor-pointer hover:text-[#cf711f] text-lg text-[#e67e22] hover:border-transparent border-b border-solid border-[#e67e22] pb-0.5 transition-all duration-300'>See all recipes →</h1>
        </div>
    </div>
  )
}
